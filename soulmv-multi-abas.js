...
const state = {
    painel:true, transf:true, aviso:true, atend:true,
    ficha:true, desc:true, conf:true, transfCC:true,
    movAtend:true, altaHosp:true
};
...
function applyFloorTemplate(code){
    ...
    let list = saved.floors[key] || templates[key] || null;
    applySelection(list);
}
